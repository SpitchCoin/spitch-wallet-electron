...
* Misc:
  ...
  * Provides list of public nodes, fetch/updated daily from [Spitch Nodes](http://spitchpool.ga/nodes.json) repo.
...
#### Windows:
1. Download the latest installer here: https://github.com/SpitchCoin/spitch-wallet-electron/releases/latest
2. Run the installer (`walletshell-<version>-win-setup.exe`) and follow the installation wizard.
3. Launch WalletShell via start menu or desktop shortcut.

#### GNU/Linux (AppImage):
1. Download latest AppImage bundle here: https://github.com/SpitchCoin/spitch-wallet-electron/releases/latest
2. Make it executable, either via GUI file manager or command line, e.g. `chmod +x walletshell-<version>-linux.AppImage`
3. Run/execute the file, double click in file manager, or run via shell/command line (See: https://docs.appimage.org/user-guide/run-appimages.html)

#### macOS
1. Download latest archive here: https://github.com/SpitchCoin/spitch-wallet-electron/releases/latest
...
# clone the repo
$ git clone https://github.com/SpitchCoin/spitch-wallet-electron
$ cd spitch-wallet-electron
...
$ mkdir -p ./bin/lin
$ cp /path/to/linux-version-of/Spitch-service ./bin/lin/turtle-service
$ npm run dist-lin

# build Windows package (you need to have wine 2.0+ installed)
$ mkdir -p ./bin/win
$ cp /path/to/win-version-of/Spitch-service.exe ./bin/win/turtle-service.exe
$ npm run dist-win

# build OSX package
$ mkdir -p ./bin/osx
$ cp /path/to/osx-version-of/Spitch-service ./bin/osx/turtle-service
$ npm run dist-mac
```
