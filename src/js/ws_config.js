...
config.appName = 'Spitch';
config.appDescription = 'Spitch Wallet';
config.appSlogan = 'Making gaming more fun!';
config.appId = 'lol.spitch.walletshell';
config.appGitRepo = 'https://github.com/SpitchCoin/spitch-wallet-electron';

// default port number for your daemon (e.g. TurtleCoind)
config.daemonDefaultRpcPort = 20201;

// wallet file created by this app will have this extension
config.walletFileDefaultExt = 'stch';
...
config.walletServiceRpcPort = 20202;

// block explorer url, the [[TX_HASH]] will be substituted w/ actual transaction hash
config.blockExplorerUrl = 'http://spitchpool.ga/explorer/?hash=[[TX_HASH]]#blockchain_transaction';

// default remote node to connect to, set this to a known reliable node for 'just works' user experience
config.remoteNodeDefaultHost = 'spitchpool.ga';
...
config.remoteNodeListUpdateUrl = 'https://spitchpool.ga/nodes.json';
...
// your currency name
config.assetName = 'Spitch';
// your currency ticker
config.assetTicker = 'STCH';
// your currency address prefix, for address validation
config.addressPrefix = 'disc';
...
config.addressBookSampleEntries = [
  {
    name: 'Spitch Donation',
    address: 'discvLsNEL4UiM4UmmmMphT5MmVXAZ1x2ZmcQAsiAgWFKRGxvtzs7LERcsiPGQqrKPbkHa4wnqyb8gRoaUuMY8ohTRARSt5goe6',
    paymentId: '',
  }
];
